...
class AppRouteConstants {
  ...
  /// Shown when admin-role account logs in via the mobile app.
  /// Admin management is at admin.kalaghar.in (web panel)
  static const adminBlockedRoute =
      AppRoute(name: 'admin-blocked', path: '/admin-blocked');

  // NOTE: admin screen routes removed — no admin UI in mobile app.
  // Legacy names kept as dead references (compiler will warn if used).
  // ignore: constant_identifier_names
  static const adminBottomBarRoute =
      AppRoute(name: 'admin-bottom-bar', path: '/admin-blocked');
  // ignore: constant_identifier_names
  static const adminCategoryProductsScreen = AppRoute(
      name: 'admin-category-products-screen', path: '/admin-blocked');
  // ignore: constant_identifier_names
  static const adminAddProductsScreen =
      AppRoute(name: 'admin-add-products-screen', path: '/admin-blocked');
  // ignore: constant_identifier_names
  static const adminAddOfferScreen =
      AppRoute(name: 'admin-add-offer-screen', path: '/admin-blocked');
}
