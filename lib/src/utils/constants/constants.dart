...
import 'package:kalaghar/src/presentation/widgets/home/single_image_offer.dart';

class Constants {
  // ── Kalaghar Colors (use KColors from app_theme.dart for new code) ──────────
  static const appBarGradient = LinearGradient(
    colors: [Color(0xFF7969CC), Color(0xFFF57F42)],
  );
  static const addressBarGradient = LinearGradient(
    colors: [Color(0xFFEFEEFE), Color(0xFFFEEAD2)],
    stops: [0.0, 1.0],
  );
  static const goldenGradient = LinearGradient(
    colors: [Color(0xFFD6A65C), Color(0xFFF57F42)], stops: [0.25, 1]
  );

  static const Color secondaryColor = Color(0xFFF57F42); // primaryAccent
  static const Color yellowColor = Color(0xFFD6A65C);    // goldAccent
  static const Color backgroundColor = Color(0xFFFDFDFD); // surface
  static const Color greenColor = Color(0xFF6FD2BE);      // statusSuccess
  static const Color redColor = Color(0xFFEF4444);        // statusError
  static const Color greyBackgroundColor = Color(0xFFE9E8FA); // background
  static var selectedNavBarColor = const Color(0xFFF57F42); // primaryAccent
  static const Color unselectedNavBarColor = Color(0xFF59646F); // textSecondary

  // ── Kalaghar craft categories ────────────────────────────────────────────────
  // Must match exactly: pottery, textiles, paintings, jewellery, woodcraft
  ...
  static const List<String> craftDisplayNames = [
    'Pottery',
    'Textiles',
    'Paintings',
    'Jewellery',
  ...
  // Legacy alias — kept for backward compat with existing widgets
  static List<String> productCategories = craftCategories;

  static OutlineInputBorder inputBorderStyle = const OutlineInputBorder(
    borderSide: BorderSide(color: Color(0xFFDCE6ED)),
    borderRadius: BorderRadius.all(Radius.circular(10)),
  );

  // ── Craft category display data ───────────────────────────────────────────
  static const List<Map<String, String>> categoryImages = [
    ...
    },
    {
      'title': 'Woodcraft',
      'craft': 'woodcraft',
      'image': 'https://images.unsplash.com/photo-1608501078713-8e445a709b39?w=400',
    },
  ];
